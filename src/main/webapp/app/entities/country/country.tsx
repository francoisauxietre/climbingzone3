    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="climbingzone3App.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="climbingzone3App.country.home.createLabel">Create a new Country</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {countryList && countryList.length > 0 ? (
            <Table responsive aria-describedby="country-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="climbingzone3App.country.name">Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="climbingzone3App.country.climbers">Climbers</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {countryList.map((country, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{country.name}</td>
                    <td>{country.climbersId ? <Link to={`climber/${country.climbersId}`}>{country.climbersId}</Link> : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="climbingzone3App.country.home.notFound">No Countries found</Translate>
            </div>
          )}
        </div>
      </div>
