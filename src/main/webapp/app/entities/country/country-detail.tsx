  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="climbingzone3App.country.detail.title">Country</Translate> [<b>{countryEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{countryEntity.climbersId ? countryEntity.climbersId : ''}</dd>
          </dl>
