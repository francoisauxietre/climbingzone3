...
export class Card extends React.Component<ICardProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="card-heading">
          <Translate contentKey="climbingzone3App.card.home.title">Cards</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="climbingzone3App.card.home.createLabel">Create a new Card</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {cardList && cardList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="climbingzone3App.card.home.notFound">No Cards found</Translate>
            </div>
          )}
        </div>
      </div>
