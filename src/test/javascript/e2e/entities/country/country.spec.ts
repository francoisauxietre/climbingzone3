...
describe('Country e2e test', () => {
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle().getAttribute('id')).to.match(/climbingzone3App.country.home.createOrEditLabel/);
  ...
  it('should create and save Countries', async () => {
    async function createCountry() {
      ...
      await countryUpdatePage.climbersSelectLastOption();
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/climbingzone3App.country.delete.question/);
